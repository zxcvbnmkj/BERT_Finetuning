...
from transformers import BertTokenizer, deepspeed
...
from train_DDP import sentence_process
from train_DP import set_logger, calculate_metrics, data_transform
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ds_file", type=str, default="./deepspeed_config.json", help="ds 配置文件路径")
    args = parser.parse_args()

    # local_rank 为 -1 表示是：单 GPU 或 CPU 训练
